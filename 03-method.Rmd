...
![Time evolution of ice-marginal lakes in terms of (a) unscaled number of lakes, (b) unscaled lake area, (c) number of lakes scaled by total number of lakes in that timestep (percent), and (d) lake area scaled by the total lake area in that timestep (percent). Lakes are colored by lake dam type (legend between panels a and b). Bar widths correspond to imagery time intervals.](/Users\Bri\Documents\CSU\EnvDataScience2022\bookdown-demo\images/f04.jpg){width=75%}
...
![Distribution of lake area frequency in 2016–2019 by lake area (colored by dam type; a) and cumulative distribution function of total lake number, total lake area, and total lake area change (1984–1988 to 2016–2019; b). Note that the x-axis is logarithmic.](/Users\Bri\Documents\CSU\EnvDataScience2022\bookdown-demo\images/f06.jpg){width=75%}
...
![Dam type distribution (spatial, frequency, and total area) for each Alaska subregion. Note: Brooks Range not pictured on map; see Fig. 1. Basemap provided by ESRI, 2021.](/Users\Bri\Documents\CSU\EnvDataScience2022\bookdown-demo\images/f08.jpg)
